...
export type Contact = { first_name: string;
    last_name: string;
    email: string;
    phone_number: string;
    city: string;
...
export type Language = 'CS' | 'SK' | 'EN' | 'DE' | 'RU' | 'PL' | 'HU' | 'RO' | 'BG' | 'HR' | 'IT' | 'FR' | 'ES' | 'UK'

export type PreAuthStatus = 'REQUESTED' | 'AUTHORIZED' | 'CAPTURED' | 'CANCELED';
